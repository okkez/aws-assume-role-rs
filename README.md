...
Options:
  ...
  -f, --format <FORMAT>                Output format [possible values: json, bash, zsh, fish, power-shell, credential-process]
...
```ini
[profile test1]
credential_process = envchain jump assume-role --role-arn=arn:aws:iam::123456789012:role/TestUser --format=credential-process
```
